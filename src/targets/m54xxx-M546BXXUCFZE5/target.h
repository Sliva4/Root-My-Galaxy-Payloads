 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "m54xxx-M546BXXUCFZE5-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_MCAST

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/m54xxx/m54xxx:16/BP4A.251205.006/M546BXXUCFZE5:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/m54xxx-M546BXXUCFZE5/p0_fingerprint.h"
...
#define ASHMEM_IOCTL_OFF                    0x00ce76c0ULL
#define ASHMEM_COMPAT_IOCTL_OFF             0x00ce7c78ULL
#define ASHMEM_MMAP_OFF                     0x00ce7cd0ULL
#define ASHMEM_OPEN_OFF                     0x00ce7f0cULL
#define ASHMEM_RELEASE_OFF                  0x00ce7f90ULL
#define ASHMEM_SHOW_FDINFO_OFF              0x00ce80b0ULL
...
/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF              0x017deab8ULL
